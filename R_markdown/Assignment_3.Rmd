...
```
   ...
   + These are the sentences that is took sample from 'sentences' in tidyverse.


```{r echo=FALSE, fig.align='center'}
knitr::kable(tibble(sentences = new_data))
```

<br>

   + And this is the final form, sorted alphabetically in lowercase letters according to their length.
